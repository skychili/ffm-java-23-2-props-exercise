import {BlogEntries} from "./BlogEntries.tsx";
import {Images} from "./Images.tsx";

export function Blog(){
    return <>
    <div>
        <BlogEntries title={"Lorem Ipsum"}
        ...
        <BlogEntries title={"More Lorem Ipsum"}
        ...
        <Images src={"https://p92.hu/binaries/content/gallery/p92website/technologies/htmlcssjs-details.png"} alt={"html icon"}/>
    </div>
